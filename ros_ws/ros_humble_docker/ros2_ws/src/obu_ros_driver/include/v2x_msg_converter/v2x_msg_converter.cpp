...
v2x_msgs::msg::ItsPduHeader V2xMsgConverter::its_pdu_header_c_to_cpp(const v2x_msgs__msg__ItsPduHeader *its_pdu_header_c)
{
    v2x_msgs::msg::ItsPduHeader its_pdu_header_cpp;
    ...
    return its_pdu_header_cpp;
}

v2x_msgs__msg__ItsPduHeader V2xMsgConverter::its_pdu_header_cpp_to_c(const v2x_msgs::msg::ItsPduHeader::SharedPtr its_pdu_header_cpp)
{
    v2x_msgs__msg__ItsPduHeader its_pdu_header_c;
    ...
    return its_pdu_header_c;
}

/* CAM */

v2x_msgs::msg::CAM V2xMsgConverter::cam__c_to_cpp(const v2x_msgs__msg__CAM *cam_c)
{
    v2x_msgs::msg::CAM cam_cpp;

    // Header
    cam_cpp.header = its_pdu_header_c_to_cpp(&cam_c->header);
...
v2x_msgs__msg__CAM V2xMsgConverter::cam__cpp_to_c(const v2x_msgs::msg::CAM::SharedPtr cam_cpp)
{
    v2x_msgs__msg__CAM cam_c;

    // Header
    cam_c.header = its_pdu_header_cpp_to_c(std::make_shared<v2x_msgs::msg::ItsPduHeader>(cam_cpp->header));
    ...
    cam_c.cam.cam_parameters.high_frequency_container.rsu_container_high_frequency.protected_communication_zones_rsu.zonesrsu.size =
    ...
    cam_c.cam.cam_parameters.high_frequency_container.rsu_container_high_frequency.protected_communication_zones_rsu.zonesrsu.capacity =
        cam_c.cam.cam_parameters.high_frequency_container.rsu_container_high_frequency.protected_communication_zones_rsu.zonesrsu.size;

    cam_c.cam.cam_parameters.high_frequency_container.rsu_container_high_frequency.protected_communication_zones_rsu.zonesrsu.data =
        new v2x_msgs__msg__ProtectedCommunicationZone[cam_c.cam.cam_parameters.high_frequency_container.rsu_container_high_frequency.protected_communication_zones_rsu.zonesrsu.size];
    ...
    cam_c.cam.cam_parameters.low_frequency_container.basic_vehicle_container_low_frequency.path_history.history.size =
        cam_cpp->cam.cam_parameters.low_frequency_container.basic_vehicle_container_low_frequency.path_history.history.size();

    cam_c.cam.cam_parameters.low_frequency_container.basic_vehicle_container_low_frequency.path_history.history.capacity =
        cam_c.cam.cam_parameters.low_frequency_container.basic_vehicle_container_low_frequency.path_history.history.size;

    cam_c.cam.cam_parameters.low_frequency_container.basic_vehicle_container_low_frequency.path_history.history.data =
        new v2x_msgs__msg__PathPoint[cam_c.cam.cam_parameters.low_frequency_container.basic_vehicle_container_low_frequency.path_history.history.size];
    ...
    cam_c.cam.cam_parameters.special_vehicle_container.public_transport_container.pt_activation.pt_activation_data.pt_activation_data.size =
    ...
    cam_c.cam.cam_parameters.special_vehicle_container.public_transport_container.pt_activation.pt_activation_data.pt_activation_data.capacity =
        cam_cpp->cam.cam_parameters.special_vehicle_container.public_transport_container.pt_activation.pt_activation_data.pt_activation_data.size();

    cam_c.cam.cam_parameters.special_vehicle_container.public_transport_container.pt_activation.pt_activation_data.pt_activation_data.data =
        new int64_t[cam_c.cam.cam_parameters.special_vehicle_container.public_transport_container.pt_activation.pt_activation_data.pt_activation_data.size];
