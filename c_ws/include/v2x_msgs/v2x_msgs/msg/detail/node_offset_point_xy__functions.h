...
#ifndef V2X_MSGS__MSG__DETAIL__NODE_OFFSET_POINT_XY__FUNCTIONS_H_
#define V2X_MSGS__MSG__DETAIL__NODE_OFFSET_POINT_XY__FUNCTIONS_H_
 ...
 * calls
 * v2x_msgs__msg__NodeOffsetPointXY__init().
...
/**
 * It calls
 * v2x_msgs__msg__NodeOffsetPointXY__fini()
 ...
 * v2x_msgs__msg__NodeOffsetPointXY__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * v2x_msgs__msg__NodeOffsetPointXY__Sequence__fini()
 * on the array,
...
#endif  // V2X_MSGS__MSG__DETAIL__NODE_OFFSET_POINT_XY__FUNCTIONS_H_
