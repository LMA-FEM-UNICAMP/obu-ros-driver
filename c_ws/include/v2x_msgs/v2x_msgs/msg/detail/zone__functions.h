...
#ifndef V2X_MSGS__MSG__DETAIL__ZONE__FUNCTIONS_H_
#define V2X_MSGS__MSG__DETAIL__ZONE__FUNCTIONS_H_
 ...
 * v2x_msgs__msg__Zone__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * v2x_msgs__msg__Zone__Sequence__fini()
 * on the array,
...
#endif  // V2X_MSGS__MSG__DETAIL__ZONE__FUNCTIONS_H_
