...
v2x_msgs__msg__LanePositions__init(v2x_msgs__msg__LanePositions * msg)
{
  ...
  // positions
  if (!v2x_msgs__msg__LanePosition__Sequence__init(&msg->positions, 0)) {
    v2x_msgs__msg__LanePositions__fini(msg);
    return false;
  }
  return true;
}
...
v2x_msgs__msg__LanePositions__fini(v2x_msgs__msg__LanePositions * msg)
{
  ...
  // positions
  v2x_msgs__msg__LanePosition__Sequence__fini(&msg->positions);
}
...
v2x_msgs__msg__LanePositions__are_equal(const v2x_msgs__msg__LanePositions * lhs, const v2x_msgs__msg__LanePositions * rhs)
{
  ...
  // positions
  if (!v2x_msgs__msg__LanePosition__Sequence__are_equal(
  ...
  v2x_msgs__msg__LanePositions * output)
{
  ...
  // positions
  if (!v2x_msgs__msg__LanePosition__Sequence__copy(
...
v2x_msgs__msg__LanePositions__create()
{
  ...
  v2x_msgs__msg__LanePositions * msg = (v2x_msgs__msg__LanePositions *)allocator.allocate(sizeof(v2x_msgs__msg__LanePositions), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(v2x_msgs__msg__LanePositions));
  bool success = v2x_msgs__msg__LanePositions__init(msg);
  if (!success) {
...
v2x_msgs__msg__LanePositions__Sequence__init(v2x_msgs__msg__LanePositions__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  v2x_msgs__msg__LanePositions * data = NULL;

  if (size) {
    data = (v2x_msgs__msg__LanePositions *)allocator.zero_allocate(size, sizeof(v2x_msgs__msg__LanePositions), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = v2x_msgs__msg__LanePositions__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        v2x_msgs__msg__LanePositions__fini(&data[i - 1]);
      }
...
v2x_msgs__msg__LanePositions__Sequence__fini(v2x_msgs__msg__LanePositions__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      v2x_msgs__msg__LanePositions__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  v2x_msgs__msg__LanePositions__Sequence * array = (v2x_msgs__msg__LanePositions__Sequence *)allocator.allocate(sizeof(v2x_msgs__msg__LanePositions__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = v2x_msgs__msg__LanePositions__Sequence__init(array, size);
  if (!success) {
...
v2x_msgs__msg__LanePositions__Sequence__destroy(v2x_msgs__msg__LanePositions__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    v2x_msgs__msg__LanePositions__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
v2x_msgs__msg__LanePositions__Sequence__are_equal(const v2x_msgs__msg__LanePositions__Sequence * lhs, const v2x_msgs__msg__LanePositions__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!v2x_msgs__msg__LanePositions__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  v2x_msgs__msg__LanePositions__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(v2x_msgs__msg__LanePositions);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    v2x_msgs__msg__LanePositions * data =
      (v2x_msgs__msg__LanePositions *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!v2x_msgs__msg__LanePositions__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          v2x_msgs__msg__LanePositions__fini(&output->data[i]);
        }
        return false;
      }
    }
