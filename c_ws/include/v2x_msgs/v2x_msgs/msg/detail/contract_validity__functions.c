...
v2x_msgs__msg__ContractValidity__init(v2x_msgs__msg__ContractValidity * msg)
{
  ...
  if (!rosidl_runtime_c__int64__Sequence__init(&msg->contract_restrictions, 0)) {
    v2x_msgs__msg__ContractValidity__fini(msg);
    return false;
  }
...
v2x_msgs__msg__ContractValidity__fini(v2x_msgs__msg__ContractValidity * msg)
{
  ...
  // contract_restrictions
  rosidl_runtime_c__int64__Sequence__fini(&msg->contract_restrictions);
  // contract_expiry_date
...
v2x_msgs__msg__ContractValidity__are_equal(const v2x_msgs__msg__ContractValidity * lhs, const v2x_msgs__msg__ContractValidity * rhs)
{
  ...
  if (!rosidl_runtime_c__int64__Sequence__are_equal(
      &(lhs->contract_restrictions), &(rhs->contract_restrictions)))
  {
    return false;
  }
  // contract_expiry_date
  ...
  v2x_msgs__msg__ContractValidity * output)
{
  ...
  if (!rosidl_runtime_c__int64__Sequence__copy(
      &(input->contract_restrictions), &(output->contract_restrictions)))
  {
    return false;
  }
  // contract_expiry_date
...
v2x_msgs__msg__ContractValidity__create()
{
  ...
  v2x_msgs__msg__ContractValidity * msg = (v2x_msgs__msg__ContractValidity *)allocator.allocate(sizeof(v2x_msgs__msg__ContractValidity), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(v2x_msgs__msg__ContractValidity));
  bool success = v2x_msgs__msg__ContractValidity__init(msg);
  if (!success) {
...
v2x_msgs__msg__ContractValidity__Sequence__init(v2x_msgs__msg__ContractValidity__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  v2x_msgs__msg__ContractValidity * data = NULL;

  if (size) {
    data = (v2x_msgs__msg__ContractValidity *)allocator.zero_allocate(size, sizeof(v2x_msgs__msg__ContractValidity), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = v2x_msgs__msg__ContractValidity__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        v2x_msgs__msg__ContractValidity__fini(&data[i - 1]);
      }
...
v2x_msgs__msg__ContractValidity__Sequence__fini(v2x_msgs__msg__ContractValidity__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      v2x_msgs__msg__ContractValidity__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  v2x_msgs__msg__ContractValidity__Sequence * array = (v2x_msgs__msg__ContractValidity__Sequence *)allocator.allocate(sizeof(v2x_msgs__msg__ContractValidity__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = v2x_msgs__msg__ContractValidity__Sequence__init(array, size);
  if (!success) {
...
v2x_msgs__msg__ContractValidity__Sequence__destroy(v2x_msgs__msg__ContractValidity__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    v2x_msgs__msg__ContractValidity__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
v2x_msgs__msg__ContractValidity__Sequence__are_equal(const v2x_msgs__msg__ContractValidity__Sequence * lhs, const v2x_msgs__msg__ContractValidity__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!v2x_msgs__msg__ContractValidity__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  v2x_msgs__msg__ContractValidity__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(v2x_msgs__msg__ContractValidity);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    v2x_msgs__msg__ContractValidity * data =
      (v2x_msgs__msg__ContractValidity *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!v2x_msgs__msg__ContractValidity__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          v2x_msgs__msg__ContractValidity__fini(&output->data[i]);
        }
        return false;
      }
    }
