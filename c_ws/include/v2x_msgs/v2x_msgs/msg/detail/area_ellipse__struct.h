...
#ifndef V2X_MSGS__MSG__DETAIL__AREA_ELLIPSE__STRUCT_H_
#define V2X_MSGS__MSG__DETAIL__AREA_ELLIPSE__STRUCT_H_
...
/// Struct defined in msg/AreaEllipse in the package v2x_msgs.
/**
  * Generated with ROS-Parser from vehicleCAPTAIN Toolbox (https://github.com/virtual-vehicle/vehicle_captain_asn1_parser)
  * Copyright: Patrizia Neubauer (https://github.com/patrizianeubauer)
 */
typedef struct v2x_msgs__msg__AreaEllipse
{
  /// Optional Field
...
// Struct for a sequence of v2x_msgs__msg__AreaEllipse.
typedef struct v2x_msgs__msg__AreaEllipse__Sequence
{
...
#endif  // V2X_MSGS__MSG__DETAIL__AREA_ELLIPSE__STRUCT_H_
