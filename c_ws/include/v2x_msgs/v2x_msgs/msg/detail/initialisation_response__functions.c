...
v2x_msgs__msg__InitialisationResponse__init(v2x_msgs__msg__InitialisationResponse * msg)
{
  ...
  if (!v2x_msgs__msg__VST__init(&msg->initialisation_response)) {
    v2x_msgs__msg__InitialisationResponse__fini(msg);
    return false;
  }
  return true;
}
...
v2x_msgs__msg__InitialisationResponse__fini(v2x_msgs__msg__InitialisationResponse * msg)
{
  ...
  // initialisation_response
  v2x_msgs__msg__VST__fini(&msg->initialisation_response);
}
...
v2x_msgs__msg__InitialisationResponse__are_equal(const v2x_msgs__msg__InitialisationResponse * lhs, const v2x_msgs__msg__InitialisationResponse * rhs)
{
  ...
  // initialisation_response
  if (!v2x_msgs__msg__VST__are_equal(
      &(lhs->initialisation_response), &(rhs->initialisation_response)))
  {
    return false;
  }
  return true;
  ...
  v2x_msgs__msg__InitialisationResponse * output)
{
  ...
  if (!v2x_msgs__msg__VST__copy(
      &(input->initialisation_response), &(output->initialisation_response)))
  {
    return false;
  }
  return true;
...
v2x_msgs__msg__InitialisationResponse__create()
{
  ...
  v2x_msgs__msg__InitialisationResponse * msg = (v2x_msgs__msg__InitialisationResponse *)allocator.allocate(sizeof(v2x_msgs__msg__InitialisationResponse), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(v2x_msgs__msg__InitialisationResponse));
  bool success = v2x_msgs__msg__InitialisationResponse__init(msg);
  if (!success) {
...
v2x_msgs__msg__InitialisationResponse__Sequence__init(v2x_msgs__msg__InitialisationResponse__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  v2x_msgs__msg__InitialisationResponse * data = NULL;

  if (size) {
    data = (v2x_msgs__msg__InitialisationResponse *)allocator.zero_allocate(size, sizeof(v2x_msgs__msg__InitialisationResponse), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = v2x_msgs__msg__InitialisationResponse__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        v2x_msgs__msg__InitialisationResponse__fini(&data[i - 1]);
      }
...
v2x_msgs__msg__InitialisationResponse__Sequence__fini(v2x_msgs__msg__InitialisationResponse__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      v2x_msgs__msg__InitialisationResponse__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  v2x_msgs__msg__InitialisationResponse__Sequence * array = (v2x_msgs__msg__InitialisationResponse__Sequence *)allocator.allocate(sizeof(v2x_msgs__msg__InitialisationResponse__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = v2x_msgs__msg__InitialisationResponse__Sequence__init(array, size);
  if (!success) {
...
v2x_msgs__msg__InitialisationResponse__Sequence__destroy(v2x_msgs__msg__InitialisationResponse__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    v2x_msgs__msg__InitialisationResponse__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
v2x_msgs__msg__InitialisationResponse__Sequence__are_equal(const v2x_msgs__msg__InitialisationResponse__Sequence * lhs, const v2x_msgs__msg__InitialisationResponse__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!v2x_msgs__msg__InitialisationResponse__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  v2x_msgs__msg__InitialisationResponse__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(v2x_msgs__msg__InitialisationResponse);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    v2x_msgs__msg__InitialisationResponse * data =
      (v2x_msgs__msg__InitialisationResponse *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!v2x_msgs__msg__InitialisationResponse__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          v2x_msgs__msg__InitialisationResponse__fini(&output->data[i]);
        }
        return false;
      }
    }
