...
v2x_msgs__msg__PayUnit__init(v2x_msgs__msg__PayUnit * msg)
{
  ...
  // pay_unit
  if (!rosidl_runtime_c__int64__Sequence__init(&msg->pay_unit, 0)) {
    v2x_msgs__msg__PayUnit__fini(msg);
    return false;
  }
  return true;
}
...
v2x_msgs__msg__PayUnit__fini(v2x_msgs__msg__PayUnit * msg)
{
  ...
  // pay_unit
  rosidl_runtime_c__int64__Sequence__fini(&msg->pay_unit);
}
  ...
  v2x_msgs__msg__PayUnit * output)
{
  ...
  if (!rosidl_runtime_c__int64__Sequence__copy(
      &(input->pay_unit), &(output->pay_unit)))
  {
    return false;
  }
  return true;
...
v2x_msgs__msg__PayUnit__create()
{
  ...
  v2x_msgs__msg__PayUnit * msg = (v2x_msgs__msg__PayUnit *)allocator.allocate(sizeof(v2x_msgs__msg__PayUnit), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(v2x_msgs__msg__PayUnit));
  bool success = v2x_msgs__msg__PayUnit__init(msg);
  if (!success) {
...
v2x_msgs__msg__PayUnit__Sequence__init(v2x_msgs__msg__PayUnit__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  v2x_msgs__msg__PayUnit * data = NULL;

  if (size) {
    data = (v2x_msgs__msg__PayUnit *)allocator.zero_allocate(size, sizeof(v2x_msgs__msg__PayUnit), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = v2x_msgs__msg__PayUnit__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        v2x_msgs__msg__PayUnit__fini(&data[i - 1]);
      }
...
v2x_msgs__msg__PayUnit__Sequence__fini(v2x_msgs__msg__PayUnit__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      v2x_msgs__msg__PayUnit__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  v2x_msgs__msg__PayUnit__Sequence * array = (v2x_msgs__msg__PayUnit__Sequence *)allocator.allocate(sizeof(v2x_msgs__msg__PayUnit__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = v2x_msgs__msg__PayUnit__Sequence__init(array, size);
  if (!success) {
...
v2x_msgs__msg__PayUnit__Sequence__destroy(v2x_msgs__msg__PayUnit__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    v2x_msgs__msg__PayUnit__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
v2x_msgs__msg__PayUnit__Sequence__are_equal(const v2x_msgs__msg__PayUnit__Sequence * lhs, const v2x_msgs__msg__PayUnit__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!v2x_msgs__msg__PayUnit__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  v2x_msgs__msg__PayUnit__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(v2x_msgs__msg__PayUnit);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    v2x_msgs__msg__PayUnit * data =
      (v2x_msgs__msg__PayUnit *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!v2x_msgs__msg__PayUnit__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          v2x_msgs__msg__PayUnit__fini(&output->data[i]);
        }
        return false;
      }
    }
