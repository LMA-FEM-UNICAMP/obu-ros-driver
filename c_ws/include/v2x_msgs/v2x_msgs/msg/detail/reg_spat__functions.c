...
v2x_msgs__msg__RegSPAT__init(v2x_msgs__msg__RegSPAT * msg)
{
  ...
  if (!v2x_msgs__msg__RegionId__init(&msg->region_id)) {
    v2x_msgs__msg__RegSPAT__fini(msg);
    return false;
  }
  return true;
}
...
v2x_msgs__msg__RegSPAT__create()
{
  ...
  v2x_msgs__msg__RegSPAT * msg = (v2x_msgs__msg__RegSPAT *)allocator.allocate(sizeof(v2x_msgs__msg__RegSPAT), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(v2x_msgs__msg__RegSPAT));
  bool success = v2x_msgs__msg__RegSPAT__init(msg);
  if (!success) {
...
v2x_msgs__msg__RegSPAT__Sequence__init(v2x_msgs__msg__RegSPAT__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  v2x_msgs__msg__RegSPAT * data = NULL;

  if (size) {
    data = (v2x_msgs__msg__RegSPAT *)allocator.zero_allocate(size, sizeof(v2x_msgs__msg__RegSPAT), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = v2x_msgs__msg__RegSPAT__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        v2x_msgs__msg__RegSPAT__fini(&data[i - 1]);
      }
...
v2x_msgs__msg__RegSPAT__Sequence__fini(v2x_msgs__msg__RegSPAT__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      v2x_msgs__msg__RegSPAT__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  v2x_msgs__msg__RegSPAT__Sequence * array = (v2x_msgs__msg__RegSPAT__Sequence *)allocator.allocate(sizeof(v2x_msgs__msg__RegSPAT__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = v2x_msgs__msg__RegSPAT__Sequence__init(array, size);
  if (!success) {
...
v2x_msgs__msg__RegSPAT__Sequence__destroy(v2x_msgs__msg__RegSPAT__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    v2x_msgs__msg__RegSPAT__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
v2x_msgs__msg__RegSPAT__Sequence__are_equal(const v2x_msgs__msg__RegSPAT__Sequence * lhs, const v2x_msgs__msg__RegSPAT__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!v2x_msgs__msg__RegSPAT__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  v2x_msgs__msg__RegSPAT__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(v2x_msgs__msg__RegSPAT);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    v2x_msgs__msg__RegSPAT * data =
      (v2x_msgs__msg__RegSPAT *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!v2x_msgs__msg__RegSPAT__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          v2x_msgs__msg__RegSPAT__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!v2x_msgs__msg__RegSPAT__copy(
