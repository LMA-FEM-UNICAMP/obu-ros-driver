...
v2x_msgs__msg__BroadcastPool__init(v2x_msgs__msg__BroadcastPool * msg)
{
  ...
  // directoryvalue
  if (!v2x_msgs__msg__Directory__init(&msg->directoryvalue)) {
    v2x_msgs__msg__BroadcastPool__fini(msg);
    return false;
  }
  // content
  if (!v2x_msgs__msg__File__Sequence__init(&msg->content, 0)) {
    v2x_msgs__msg__BroadcastPool__fini(msg);
    return false;
  }
  return true;
...
v2x_msgs__msg__BroadcastPool__fini(v2x_msgs__msg__BroadcastPool * msg)
{
  ...
  // directoryvalue
  v2x_msgs__msg__Directory__fini(&msg->directoryvalue);
  // content
  v2x_msgs__msg__File__Sequence__fini(&msg->content);
}
...
v2x_msgs__msg__BroadcastPool__are_equal(const v2x_msgs__msg__BroadcastPool * lhs, const v2x_msgs__msg__BroadcastPool * rhs)
{
  ...
  if (!v2x_msgs__msg__Directory__are_equal(
      &(lhs->directoryvalue), &(rhs->directoryvalue)))
  {
    return false;
  }
  // content
  if (!v2x_msgs__msg__File__Sequence__are_equal(
  ...
  v2x_msgs__msg__BroadcastPool * output)
{
  ...
  if (!v2x_msgs__msg__Directory__copy(
      &(input->directoryvalue), &(output->directoryvalue)))
  {
    return false;
  }
  // content
  if (!v2x_msgs__msg__File__Sequence__copy(
...
v2x_msgs__msg__BroadcastPool__create()
{
  ...
  v2x_msgs__msg__BroadcastPool * msg = (v2x_msgs__msg__BroadcastPool *)allocator.allocate(sizeof(v2x_msgs__msg__BroadcastPool), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(v2x_msgs__msg__BroadcastPool));
  bool success = v2x_msgs__msg__BroadcastPool__init(msg);
  if (!success) {
...
v2x_msgs__msg__BroadcastPool__Sequence__init(v2x_msgs__msg__BroadcastPool__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  v2x_msgs__msg__BroadcastPool * data = NULL;

  if (size) {
    data = (v2x_msgs__msg__BroadcastPool *)allocator.zero_allocate(size, sizeof(v2x_msgs__msg__BroadcastPool), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = v2x_msgs__msg__BroadcastPool__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        v2x_msgs__msg__BroadcastPool__fini(&data[i - 1]);
      }
...
v2x_msgs__msg__BroadcastPool__Sequence__fini(v2x_msgs__msg__BroadcastPool__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      v2x_msgs__msg__BroadcastPool__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  v2x_msgs__msg__BroadcastPool__Sequence * array = (v2x_msgs__msg__BroadcastPool__Sequence *)allocator.allocate(sizeof(v2x_msgs__msg__BroadcastPool__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = v2x_msgs__msg__BroadcastPool__Sequence__init(array, size);
  if (!success) {
...
v2x_msgs__msg__BroadcastPool__Sequence__destroy(v2x_msgs__msg__BroadcastPool__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    v2x_msgs__msg__BroadcastPool__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
v2x_msgs__msg__BroadcastPool__Sequence__are_equal(const v2x_msgs__msg__BroadcastPool__Sequence * lhs, const v2x_msgs__msg__BroadcastPool__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!v2x_msgs__msg__BroadcastPool__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  v2x_msgs__msg__BroadcastPool__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(v2x_msgs__msg__BroadcastPool);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    v2x_msgs__msg__BroadcastPool * data =
      (v2x_msgs__msg__BroadcastPool *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!v2x_msgs__msg__BroadcastPool__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          v2x_msgs__msg__BroadcastPool__fini(&output->data[i]);
        }
        return false;
      }
    }
