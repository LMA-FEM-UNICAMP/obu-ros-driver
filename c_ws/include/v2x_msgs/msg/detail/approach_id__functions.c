...
v2x_msgs__msg__ApproachID__are_equal(const v2x_msgs__msg__ApproachID * lhs, const v2x_msgs__msg__ApproachID * rhs)
{
  ...
  // approach_id
  if (lhs->approach_id != rhs->approach_id) {
    return false;
  }
  return true;
}
  ...
  v2x_msgs__msg__ApproachID * output)
{
  ...
  // approach_id
  output->approach_id = input->approach_id;
  return true;
}
...
v2x_msgs__msg__ApproachID__create()
{
  ...
  v2x_msgs__msg__ApproachID * msg = (v2x_msgs__msg__ApproachID *)allocator.allocate(sizeof(v2x_msgs__msg__ApproachID), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(v2x_msgs__msg__ApproachID));
  bool success = v2x_msgs__msg__ApproachID__init(msg);
  if (!success) {
...
v2x_msgs__msg__ApproachID__destroy(v2x_msgs__msg__ApproachID * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    v2x_msgs__msg__ApproachID__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
v2x_msgs__msg__ApproachID__Sequence__init(v2x_msgs__msg__ApproachID__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  v2x_msgs__msg__ApproachID * data = NULL;

  if (size) {
    data = (v2x_msgs__msg__ApproachID *)allocator.zero_allocate(size, sizeof(v2x_msgs__msg__ApproachID), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = v2x_msgs__msg__ApproachID__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        v2x_msgs__msg__ApproachID__fini(&data[i - 1]);
      }
...
v2x_msgs__msg__ApproachID__Sequence__fini(v2x_msgs__msg__ApproachID__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      v2x_msgs__msg__ApproachID__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  v2x_msgs__msg__ApproachID__Sequence * array = (v2x_msgs__msg__ApproachID__Sequence *)allocator.allocate(sizeof(v2x_msgs__msg__ApproachID__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = v2x_msgs__msg__ApproachID__Sequence__init(array, size);
  if (!success) {
...
v2x_msgs__msg__ApproachID__Sequence__destroy(v2x_msgs__msg__ApproachID__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    v2x_msgs__msg__ApproachID__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
v2x_msgs__msg__ApproachID__Sequence__are_equal(const v2x_msgs__msg__ApproachID__Sequence * lhs, const v2x_msgs__msg__ApproachID__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!v2x_msgs__msg__ApproachID__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  v2x_msgs__msg__ApproachID__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(v2x_msgs__msg__ApproachID);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    v2x_msgs__msg__ApproachID * data =
      (v2x_msgs__msg__ApproachID *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!v2x_msgs__msg__ApproachID__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          v2x_msgs__msg__ApproachID__fini(&output->data[i]);
        }
        return false;
      }
    }
