...
#ifndef V2X_MSGS__MSG__DETAIL__POSITIONAL_ACCURACY__FUNCTIONS_H_
#define V2X_MSGS__MSG__DETAIL__POSITIONAL_ACCURACY__FUNCTIONS_H_
 ...
 * calls
 * v2x_msgs__msg__PositionalAccuracy__init().
...
/**
 * It calls
 * v2x_msgs__msg__PositionalAccuracy__fini()
 ...
 * v2x_msgs__msg__PositionalAccuracy__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * v2x_msgs__msg__PositionalAccuracy__Sequence__fini()
 * on the array,
...
#endif  // V2X_MSGS__MSG__DETAIL__POSITIONAL_ACCURACY__FUNCTIONS_H_
