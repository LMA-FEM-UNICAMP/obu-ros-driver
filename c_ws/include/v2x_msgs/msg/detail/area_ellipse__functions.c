...
bool
v2x_msgs__msg__AreaEllipse__init(v2x_msgs__msg__AreaEllipse * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!v2x_msgs__msg__OffsetPoint__init(&msg->node_center_point)) {
    v2x_msgs__msg__AreaEllipse__fini(msg);
    return false;
  }
...
void
v2x_msgs__msg__AreaEllipse__fini(v2x_msgs__msg__AreaEllipse * msg)
{
  if (!msg) {
    return;
  }
...
bool
v2x_msgs__msg__AreaEllipse__are_equal(const v2x_msgs__msg__AreaEllipse * lhs, const v2x_msgs__msg__AreaEllipse * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
v2x_msgs__msg__AreaEllipse__copy(
  const v2x_msgs__msg__AreaEllipse * input,
  v2x_msgs__msg__AreaEllipse * output)
{
  if (!input || !output) {
    return false;
  }
...
v2x_msgs__msg__AreaEllipse *
v2x_msgs__msg__AreaEllipse__create()
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  v2x_msgs__msg__AreaEllipse * msg = (v2x_msgs__msg__AreaEllipse *)allocator.allocate(sizeof(v2x_msgs__msg__AreaEllipse), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(v2x_msgs__msg__AreaEllipse));
  bool success = v2x_msgs__msg__AreaEllipse__init(msg);
  if (!success) {
...
void
v2x_msgs__msg__AreaEllipse__destroy(v2x_msgs__msg__AreaEllipse * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    v2x_msgs__msg__AreaEllipse__fini(msg);
...
bool
v2x_msgs__msg__AreaEllipse__Sequence__init(v2x_msgs__msg__AreaEllipse__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  v2x_msgs__msg__AreaEllipse * data = NULL;

  if (size) {
    data = (v2x_msgs__msg__AreaEllipse *)allocator.zero_allocate(size, sizeof(v2x_msgs__msg__AreaEllipse), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = v2x_msgs__msg__AreaEllipse__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        v2x_msgs__msg__AreaEllipse__fini(&data[i - 1]);
      }
...
void
v2x_msgs__msg__AreaEllipse__Sequence__fini(v2x_msgs__msg__AreaEllipse__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      v2x_msgs__msg__AreaEllipse__fini(&array->data[i]);
    }
...
v2x_msgs__msg__AreaEllipse__Sequence *
v2x_msgs__msg__AreaEllipse__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  v2x_msgs__msg__AreaEllipse__Sequence * array = (v2x_msgs__msg__AreaEllipse__Sequence *)allocator.allocate(sizeof(v2x_msgs__msg__AreaEllipse__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = v2x_msgs__msg__AreaEllipse__Sequence__init(array, size);
  if (!success) {
...
void
v2x_msgs__msg__AreaEllipse__Sequence__destroy(v2x_msgs__msg__AreaEllipse__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    v2x_msgs__msg__AreaEllipse__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
v2x_msgs__msg__AreaEllipse__Sequence__are_equal(const v2x_msgs__msg__AreaEllipse__Sequence * lhs, const v2x_msgs__msg__AreaEllipse__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!v2x_msgs__msg__AreaEllipse__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
v2x_msgs__msg__AreaEllipse__Sequence__copy(
  const v2x_msgs__msg__AreaEllipse__Sequence * input,
  v2x_msgs__msg__AreaEllipse__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(v2x_msgs__msg__AreaEllipse);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    v2x_msgs__msg__AreaEllipse * data =
      (v2x_msgs__msg__AreaEllipse *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!v2x_msgs__msg__AreaEllipse__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          v2x_msgs__msg__AreaEllipse__fini(&output->data[i]);
        }
        return false;
      }
    }
