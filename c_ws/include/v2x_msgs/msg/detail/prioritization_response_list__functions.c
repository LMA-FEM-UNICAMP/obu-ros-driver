...
v2x_msgs__msg__PrioritizationResponseList__init(v2x_msgs__msg__PrioritizationResponseList * msg)
{
  ...
  // list
  if (!v2x_msgs__msg__PrioritizationResponse__Sequence__init(&msg->list, 0)) {
    v2x_msgs__msg__PrioritizationResponseList__fini(msg);
    return false;
  }
  return true;
}
...
v2x_msgs__msg__PrioritizationResponseList__fini(v2x_msgs__msg__PrioritizationResponseList * msg)
{
  ...
  // list
  v2x_msgs__msg__PrioritizationResponse__Sequence__fini(&msg->list);
}
...
v2x_msgs__msg__PrioritizationResponseList__are_equal(const v2x_msgs__msg__PrioritizationResponseList * lhs, const v2x_msgs__msg__PrioritizationResponseList * rhs)
{
  ...
  // list
  if (!v2x_msgs__msg__PrioritizationResponse__Sequence__are_equal(
      &(lhs->list), &(rhs->list)))
  {
    return false;
  }
  ...
  v2x_msgs__msg__PrioritizationResponseList * output)
{
  ...
  // list
  if (!v2x_msgs__msg__PrioritizationResponse__Sequence__copy(
...
v2x_msgs__msg__PrioritizationResponseList__create()
{
  ...
  v2x_msgs__msg__PrioritizationResponseList * msg = (v2x_msgs__msg__PrioritizationResponseList *)allocator.allocate(sizeof(v2x_msgs__msg__PrioritizationResponseList), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(v2x_msgs__msg__PrioritizationResponseList));
  bool success = v2x_msgs__msg__PrioritizationResponseList__init(msg);
  if (!success) {
...
v2x_msgs__msg__PrioritizationResponseList__Sequence__init(v2x_msgs__msg__PrioritizationResponseList__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  v2x_msgs__msg__PrioritizationResponseList * data = NULL;

  if (size) {
    data = (v2x_msgs__msg__PrioritizationResponseList *)allocator.zero_allocate(size, sizeof(v2x_msgs__msg__PrioritizationResponseList), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = v2x_msgs__msg__PrioritizationResponseList__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        v2x_msgs__msg__PrioritizationResponseList__fini(&data[i - 1]);
      }
...
v2x_msgs__msg__PrioritizationResponseList__Sequence__fini(v2x_msgs__msg__PrioritizationResponseList__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      v2x_msgs__msg__PrioritizationResponseList__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  v2x_msgs__msg__PrioritizationResponseList__Sequence * array = (v2x_msgs__msg__PrioritizationResponseList__Sequence *)allocator.allocate(sizeof(v2x_msgs__msg__PrioritizationResponseList__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = v2x_msgs__msg__PrioritizationResponseList__Sequence__init(array, size);
  if (!success) {
...
v2x_msgs__msg__PrioritizationResponseList__Sequence__destroy(v2x_msgs__msg__PrioritizationResponseList__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    v2x_msgs__msg__PrioritizationResponseList__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
v2x_msgs__msg__PrioritizationResponseList__Sequence__are_equal(const v2x_msgs__msg__PrioritizationResponseList__Sequence * lhs, const v2x_msgs__msg__PrioritizationResponseList__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!v2x_msgs__msg__PrioritizationResponseList__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  v2x_msgs__msg__PrioritizationResponseList__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(v2x_msgs__msg__PrioritizationResponseList);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    v2x_msgs__msg__PrioritizationResponseList * data =
      (v2x_msgs__msg__PrioritizationResponseList *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!v2x_msgs__msg__PrioritizationResponseList__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          v2x_msgs__msg__PrioritizationResponseList__fini(&output->data[i]);
        }
        return false;
      }
    }
