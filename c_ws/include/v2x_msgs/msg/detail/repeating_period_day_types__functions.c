...
v2x_msgs__msg__RepeatingPeriodDayTypes__are_equal(const v2x_msgs__msg__RepeatingPeriodDayTypes * lhs, const v2x_msgs__msg__RepeatingPeriodDayTypes * rhs)
{
  ...
  // repeating_period_day_types
  if (lhs->repeating_period_day_types != rhs->repeating_period_day_types) {
    return false;
  }
  return true;
}
  ...
  v2x_msgs__msg__RepeatingPeriodDayTypes * output)
{
  ...
  // repeating_period_day_types
  output->repeating_period_day_types = input->repeating_period_day_types;
  return true;
}
...
v2x_msgs__msg__RepeatingPeriodDayTypes__create()
{
  ...
  v2x_msgs__msg__RepeatingPeriodDayTypes * msg = (v2x_msgs__msg__RepeatingPeriodDayTypes *)allocator.allocate(sizeof(v2x_msgs__msg__RepeatingPeriodDayTypes), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(v2x_msgs__msg__RepeatingPeriodDayTypes));
  bool success = v2x_msgs__msg__RepeatingPeriodDayTypes__init(msg);
  if (!success) {
...
v2x_msgs__msg__RepeatingPeriodDayTypes__destroy(v2x_msgs__msg__RepeatingPeriodDayTypes * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    v2x_msgs__msg__RepeatingPeriodDayTypes__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
v2x_msgs__msg__RepeatingPeriodDayTypes__Sequence__init(v2x_msgs__msg__RepeatingPeriodDayTypes__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  v2x_msgs__msg__RepeatingPeriodDayTypes * data = NULL;

  if (size) {
    data = (v2x_msgs__msg__RepeatingPeriodDayTypes *)allocator.zero_allocate(size, sizeof(v2x_msgs__msg__RepeatingPeriodDayTypes), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = v2x_msgs__msg__RepeatingPeriodDayTypes__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        v2x_msgs__msg__RepeatingPeriodDayTypes__fini(&data[i - 1]);
      }
...
v2x_msgs__msg__RepeatingPeriodDayTypes__Sequence__fini(v2x_msgs__msg__RepeatingPeriodDayTypes__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      v2x_msgs__msg__RepeatingPeriodDayTypes__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  v2x_msgs__msg__RepeatingPeriodDayTypes__Sequence * array = (v2x_msgs__msg__RepeatingPeriodDayTypes__Sequence *)allocator.allocate(sizeof(v2x_msgs__msg__RepeatingPeriodDayTypes__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = v2x_msgs__msg__RepeatingPeriodDayTypes__Sequence__init(array, size);
  if (!success) {
...
v2x_msgs__msg__RepeatingPeriodDayTypes__Sequence__destroy(v2x_msgs__msg__RepeatingPeriodDayTypes__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    v2x_msgs__msg__RepeatingPeriodDayTypes__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
v2x_msgs__msg__RepeatingPeriodDayTypes__Sequence__are_equal(const v2x_msgs__msg__RepeatingPeriodDayTypes__Sequence * lhs, const v2x_msgs__msg__RepeatingPeriodDayTypes__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!v2x_msgs__msg__RepeatingPeriodDayTypes__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  v2x_msgs__msg__RepeatingPeriodDayTypes__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(v2x_msgs__msg__RepeatingPeriodDayTypes);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    v2x_msgs__msg__RepeatingPeriodDayTypes * data =
      (v2x_msgs__msg__RepeatingPeriodDayTypes *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!v2x_msgs__msg__RepeatingPeriodDayTypes__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          v2x_msgs__msg__RepeatingPeriodDayTypes__fini(&output->data[i]);
        }
        return false;
      }
    }
