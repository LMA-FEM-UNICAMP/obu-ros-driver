...
v2x_msgs__msg__AbsolutePositions__init(v2x_msgs__msg__AbsolutePositions * msg)
{
  ...
  // positions
  if (!v2x_msgs__msg__AbsolutePosition__Sequence__init(&msg->positions, 0)) {
    v2x_msgs__msg__AbsolutePositions__fini(msg);
    return false;
  }
  return true;
}
...
v2x_msgs__msg__AbsolutePositions__fini(v2x_msgs__msg__AbsolutePositions * msg)
{
  ...
  // positions
  v2x_msgs__msg__AbsolutePosition__Sequence__fini(&msg->positions);
}
...
v2x_msgs__msg__AbsolutePositions__are_equal(const v2x_msgs__msg__AbsolutePositions * lhs, const v2x_msgs__msg__AbsolutePositions * rhs)
{
  ...
  // positions
  if (!v2x_msgs__msg__AbsolutePosition__Sequence__are_equal(
  ...
  v2x_msgs__msg__AbsolutePositions * output)
{
  ...
  // positions
  if (!v2x_msgs__msg__AbsolutePosition__Sequence__copy(
...
v2x_msgs__msg__AbsolutePositions__create()
{
  ...
  v2x_msgs__msg__AbsolutePositions * msg = (v2x_msgs__msg__AbsolutePositions *)allocator.allocate(sizeof(v2x_msgs__msg__AbsolutePositions), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(v2x_msgs__msg__AbsolutePositions));
  bool success = v2x_msgs__msg__AbsolutePositions__init(msg);
  if (!success) {
...
v2x_msgs__msg__AbsolutePositions__Sequence__init(v2x_msgs__msg__AbsolutePositions__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  v2x_msgs__msg__AbsolutePositions * data = NULL;

  if (size) {
    data = (v2x_msgs__msg__AbsolutePositions *)allocator.zero_allocate(size, sizeof(v2x_msgs__msg__AbsolutePositions), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = v2x_msgs__msg__AbsolutePositions__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        v2x_msgs__msg__AbsolutePositions__fini(&data[i - 1]);
      }
...
v2x_msgs__msg__AbsolutePositions__Sequence__fini(v2x_msgs__msg__AbsolutePositions__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      v2x_msgs__msg__AbsolutePositions__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  v2x_msgs__msg__AbsolutePositions__Sequence * array = (v2x_msgs__msg__AbsolutePositions__Sequence *)allocator.allocate(sizeof(v2x_msgs__msg__AbsolutePositions__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = v2x_msgs__msg__AbsolutePositions__Sequence__init(array, size);
  if (!success) {
...
v2x_msgs__msg__AbsolutePositions__Sequence__destroy(v2x_msgs__msg__AbsolutePositions__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    v2x_msgs__msg__AbsolutePositions__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
v2x_msgs__msg__AbsolutePositions__Sequence__are_equal(const v2x_msgs__msg__AbsolutePositions__Sequence * lhs, const v2x_msgs__msg__AbsolutePositions__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!v2x_msgs__msg__AbsolutePositions__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  v2x_msgs__msg__AbsolutePositions__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(v2x_msgs__msg__AbsolutePositions);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    v2x_msgs__msg__AbsolutePositions * data =
      (v2x_msgs__msg__AbsolutePositions *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!v2x_msgs__msg__AbsolutePositions__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          v2x_msgs__msg__AbsolutePositions__fini(&output->data[i]);
        }
        return false;
      }
    }
