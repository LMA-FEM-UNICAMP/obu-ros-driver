...
#ifndef V2X_MSGS__MSG__DETAIL__YAW_RATE_CONFIDENCE__FUNCTIONS_H_
#define V2X_MSGS__MSG__DETAIL__YAW_RATE_CONFIDENCE__FUNCTIONS_H_
 ...
 * calls
 * v2x_msgs__msg__YawRateConfidence__init().
...
/**
 * It calls
 * v2x_msgs__msg__YawRateConfidence__fini()
 ...
 * v2x_msgs__msg__YawRateConfidence__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * v2x_msgs__msg__YawRateConfidence__Sequence__fini()
 * on the array,
...
#endif  // V2X_MSGS__MSG__DETAIL__YAW_RATE_CONFIDENCE__FUNCTIONS_H_
